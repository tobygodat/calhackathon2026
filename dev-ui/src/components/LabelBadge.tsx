...
const LABEL_STYLES: Record<Label, string> = {
  VERIFIES: "bg-emerald-500/20 text-emerald-300 border-emerald-500/30",
  CONTRADICTS: "bg-red-500/20 text-red-300 border-red-500/30",
  EXTENDS: "bg-blue-500/20 text-blue-300 border-blue-500/30",
  TANGENTIAL: "bg-slate-500/20 text-slate-400 border-slate-500/30",
...
const LABEL_TEXT: Record<Label, string> = {
  ...
  EXTENDS: "Extends",
  TANGENTIAL: "Tangential findings",
  SCOOP: "Scoop",
};
